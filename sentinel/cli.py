...
def main() -> None:
    ...
    # Subcomando patch
    patch_parser = subparsers.add_parser("patch", help="Genera una propuesta de parche (Artifact) para un archivo.")
    ...
    try:
        if args.command == "scan":
            ...
            print(f"✅ Propuesta de parche (Artifact Zero Trust) creada exitosamente en:\n  {artifact}")
